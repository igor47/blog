...
intrussive. My blog was mostly static anyhow: Wrote [Markdown][markdown] blog
...
repo with the name "<username>.github.com", i.e. I push to the repo at
[Sirupsen/sirupsen.github.com][source]. Here's a little guide to [migrate 
from other blogging systems][migrate].
